...
import ArrayControlStyled, { TestArrayControl as ArrayControl } from "./control.array";
...
describe("ArrayControl", () => {
    ...
    test("should add an item to the array if the add button has been clicked", () => {
        ...
        expect(callback.mock.calls[0][0]).toEqual(void 0);
    ...
    test("should remove an array item if the remove button has been clicked", () => {
        ...
        expect(callback.mock.calls[0][1]).toBe(true);
        expect(callback.mock.calls[0][2]).toBe(1);
    });
    ...
    test("should fire an `onSectionUpdate` callback with a link is clicked", () => {
        ...
        expect(handleSectionUpdate.mock.calls[0][0]).toEqual("items");
