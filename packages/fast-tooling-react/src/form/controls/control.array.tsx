...
> {
    ...
    private handleAddArrayItem(): void {
        if (typeof this.props.value === "undefined") {
            this.props.onChange([this.props.onAddExampleData("items")]);
        } else {
            this.props.onChange(this.props.onAddExampleData("items"), true);
        }
    }
    ...
    private handleRemoveArrayItem(index: number): void {
        this.props.onChange(void 0, true, index);
    }
