...
> {
    ...
    private onEditComponent(component: ChildComponent, index: number): void {
        ...
        this.props.onUpdateSection("", dataLocation, childSchema);
    }
    ...
    private onDeleteComponent(index?: number): void {
        this.props.onChange(undefined, typeof index === "number", index);
    }
    ...
    private onAddComponent(item: FormChildOptionItem, navigateToItem: boolean): void {
        ...
        if (items !== null) {
            this.props.onChange(items, undefined, undefined);
...
const TestChildrenControl: typeof ChildrenControl &
    ContextComponent<any> = DragDropContext(HTML5Backend)(ChildrenControl);

export { TestChildrenControl };
