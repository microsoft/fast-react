export interface NavigationMessageSystemPluginProps {
    /**
...
export default abstract class NavigationMessageSystemPlugin<
    C extends NavigationMessageSystemPluginProps
> {
    private config: C;
