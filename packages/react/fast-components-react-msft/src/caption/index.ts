...
import CaptionStyles from "@microsoft/fast-components-styles-msft/css/caption.css";
 ...
 */
const Caption = manageJss(CaptionStyles)(MergeManagedClasses(MSFTCaption, CaptionStyles));
