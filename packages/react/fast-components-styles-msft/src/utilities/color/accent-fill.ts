...
export const accentFillRest = "var(--accent-fill-rest)";
export const accentFillHover = "var(--accent-fill-hover)";
export const accentFillActive = "var(--accent-fill-active)";
export const accentFillFocus = "var(--accent-fill-focus)";
export const accentFillSelected = "var(--accent-fill-selected)";
export const accentFillLargeRest = "var(--accent-fill-large-rest)";
export const accentFillLargeHover = "var(--accent-fill-large-hover)";
export const accentFillLargeActive = "var(--accent-fill-large-active)";
export const accentFillLargeFocus = "var(--accent-fill-large-focus)";
export const accentFillLargeSelected = "var(--accent-fill-large-selected)";
