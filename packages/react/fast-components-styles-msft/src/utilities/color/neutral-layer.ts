...
export const neutralLayerFloatingCustomProperty = "var(--neutral-layer-floating)";
export const neutralLayerCardCustomProperty = "var(--neutral-layer-card)";
export const neutralLayerCardContainerCustomProperty =
    "var(--neutral-layer-card-container)";
export const neutralLayerL1CustomProperty = "var(--neutral-layer-L1)";
export const neutralLayerL1AltCustomProperty = "var(--neutral-layer-L1-alt)";
