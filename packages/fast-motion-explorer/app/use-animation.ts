...
//
//     const [jssObject, setJssObject]: any = useState((): string => {
//         const sheet: any = {
...
//     });
//     // if any of the inputs into JSSObject are stale, we need to re-create JSSObject
//     // [
//     //     duration[0],
//     //     duration[1],
//     //     delay[0],
...
//      */
//     // return classNames;
//     // return className.current as any;
//     return jssObject.classes
// }
